$(function(){
    var event = {
        makeCenter : function(){
            $('#choose-box-wrapper-major').css("display","block");
            $('#choose-box-wrapper-major').css("position","absolute");
            $('#choose-box-wrapper-major').css("top", Math.max(0, (($(window).height() - $('#choose-box-wrapper-major').outerHeight()) / 2) + $(window).scrollTop()) + "px");
            $('#choose-box-wrapper-major').css("left", Math.max(0, (($(window).width() - $('#choose-box-wrapper-major').outerWidth()) / 2) + $(window).scrollLeft()) + "px");
        },
        ...
        initMajor : function(majorClassID){
            ...
            $('.major-item').bind('click', function(){
                    ...
                    //关闭弹窗
                    $('#choose-box-wrapper-major').css("display","none");
                }
            );
